...
public class ParteA {
    ...
    public void executeParteATest() {
        ...
        *  Instanciar una Central de Vehiculos e inicializarla con los datos del archivo formato JSON de la version mas completa y correcta disponible.
        ...
        public void darDatosClientes()
        {
            for (i=0; i<darListaClientes;  i++ )
            {
                System.out.println(darListaClientes[i].darDatos());    
            }
        }
        /** Mostrar el nombre, apellido, identificador y la prioridad de cada cliente */


        long tInicioRuta = System.nanoTime();
        /**TODO Requerimiento 2: Utilizar la prioridad de los clientes para definir una ruta con las paradas autorizadas de recogida y/o de 
        *entrega de pedidos/despachos a los clientes.
        ...
        * Recibe la informacion necesaria de la ruta para actualizarla segun la prioridad de sus clientes.
        ...
        /**TODO Mostrar la informacion de paradas autorizadas de la ruta. Por cada para parada mostrar: Id pedido/despacho, id cliente, 
        *prioridad del cliente, punto. La informacion se muestra en el orden de recorrido de la ruta. */
